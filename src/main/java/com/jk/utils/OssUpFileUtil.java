...
public class OssUpFileUtil {
     ...
     */
    private static String accessKeyId = "LTAIgDV5N6Diw3ov";
    private static String accessKeySecret = "yamvAWfSWeiWCS2lJU6TZmX3FjM4CY";
    /**
     * Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
     */
    private static String bucketName = "blog-111";
    /**
     * OSS文件夹名称
     */
    private static String firstHost = "img";
    /**
